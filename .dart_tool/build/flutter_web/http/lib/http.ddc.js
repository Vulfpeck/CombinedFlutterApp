define(['dart_sdk', 'packages/http/src/base_client', 'packages/http_parser/http_parser'], function(dart_sdk, packages__http__src__base_client, packages__http_parser__http_parser) {
  ...
  const MultipartFile_field = dart.privateName(multipart_file, "MultipartFile.field");
  const MultipartFile_length = dart.privateName(multipart_file, "MultipartFile.length");
  const MultipartFile_filename = dart.privateName(multipart_file, "MultipartFile.filename");
  const MultipartFile_contentType = dart.privateName(multipart_file, "MultipartFile.contentType");
  ...
  const field$ = MultipartFile_field;
  const length$ = MultipartFile_length;
  const filename$ = MultipartFile_filename;
  const contentType$ = MultipartFile_contentType;
  ...
  const MultipartRequest_fields = dart.privateName(multipart_request, "MultipartRequest.fields");
  ...
  const fields = MultipartRequest_fields;
