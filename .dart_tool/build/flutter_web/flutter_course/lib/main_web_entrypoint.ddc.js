define(['dart_sdk', 'packages/flutter_course/main'], function(dart_sdk, packages__flutter_course__main) {
  'use strict';
  ...
  const main = packages__flutter_course__main.main;
  ...
  dart.trackLibraries("packages/flutter_course/main_web_entrypoint", {
    "package:flutter_course/main_web_entrypoint.dart": main_web_entrypoint
  }, {
