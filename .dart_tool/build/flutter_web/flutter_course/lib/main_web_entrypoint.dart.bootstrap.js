...
let modulePaths = {
 ...
 "packages/flutter_course/main": "packages/flutter_course/main.ddc",
 "packages/flutter_course/main_web_entrypoint": "packages/flutter_course/main_web_entrypoint.ddc",
 "packages/flutter_course/models/auth": "packages/flutter_course/models/auth.ddc",
 "packages/flutter_course/models/location_data": "packages/flutter_course/models/location_data.ddc",
 "packages/flutter_course/models/product": "packages/flutter_course/models/product.ddc",
 "packages/flutter_course/models/user": "packages/flutter_course/models/user.ddc",
 "packages/flutter_course/pages/auth": "packages/flutter_course/pages/auth.ddc",
 "packages/flutter_course/pages/product": "packages/flutter_course/pages/product.ddc",
 "packages/flutter_course/pages/product_edit": "packages/flutter_course/pages/product_edit.ddc",
 "packages/flutter_course/pages/product_list": "packages/flutter_course/pages/product_list.ddc",
 "packages/flutter_course/pages/products": "packages/flutter_course/pages/products.ddc",
 "packages/flutter_course/pages/products_admin": "packages/flutter_course/pages/products_admin.ddc",
 "packages/flutter_course/scoped-models/connected_products": "packages/flutter_course/scoped-models/connected_products.ddc",
 "packages/flutter_course/scoped-models/main": "packages/flutter_course/scoped-models/main.ddc",
 "packages/flutter_course/shared/global_config": "packages/flutter_course/shared/global_config.ddc",
 "packages/flutter_course/widgets/form_inputs/image_input": "packages/flutter_course/widgets/form_inputs/image_input.ddc",
 "packages/flutter_course/widgets/form_inputs/location": "packages/flutter_course/widgets/form_inputs/location.ddc",
 "packages/flutter_course/widgets/helpers/custom_route": "packages/flutter_course/widgets/helpers/custom_route.ddc",
 "packages/flutter_course/widgets/products/product_card": "packages/flutter_course/widgets/products/product_card.ddc",
 "packages/flutter_course/widgets/products/product_fab": "packages/flutter_course/widgets/products/product_fab.ddc",
 "packages/flutter_course/widgets/products/products": "packages/flutter_course/widgets/products/products.ddc",
 "packages/flutter_course/widgets/ui_elements/logout_list_tile": "packages/flutter_course/widgets/ui_elements/logout_list_tile.ddc",
 "packages/flutter_course/widgets/ui_elements/title_default": "packages/flutter_course/widgets/ui_elements/title_default.ddc",
 ...
 "packages/location/location": "packages/location/location.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/flutter_course/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:flutter_course/main_web_entrypoint.dart") {
          // Clear static caches.
