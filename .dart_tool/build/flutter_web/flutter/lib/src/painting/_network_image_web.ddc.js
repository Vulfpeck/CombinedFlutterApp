define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/flutter/gestures', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__flutter__gestures, packages__vector_math__vector_math_64) {
  ...
  image_provider.ResizeImage = class ResizeImage extends image_provider.ImageProvider$(image_provider._SizeAwareCacheKey) {
    ...
    load(key, decode) {
      ...
      let decodeResize = dart.fn((bytes, opts) => {
        ...
        if (!(cacheWidth == null && cacheHeight == null)) dart.assertFailed("ResizeImage cannot be composed with another ImageProvider that applies cacheWidth or cacheHeight.", "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 547, 9, "cacheWidth == null && cacheHeight == null");
  ...
  image_provider.FileImage = class FileImage extends image_provider.ImageProvider {
    ...
    [_loadAsync](key, decode) {
      return async.async(ui.Codec, (function* _loadAsync() {
        if (!dart.equals(key, this)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 635, 12, "key == this");
  ...
  (image_provider.FileImage.new = function(file, opts) {
    ...
    this[file$] = file;
    this[scale$0] = scale;
    if (!(file != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 609, 14, "file != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 610, 14, "scale != null");
  ...
  image_provider.MemoryImage = class MemoryImage extends image_provider.ImageProvider {
    ...
    [_loadAsync](key, decode) {
      if (!dart.equals(key, this)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 700, 12, "key == this");
  ...
  (image_provider.MemoryImage.new = function(bytes, opts) {
    ...
    this[bytes$] = bytes;
    this[scale$1] = scale;
    if (!(bytes != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 677, 14, "bytes != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 678, 14, "scale != null");
  ...
  (image_provider.ExactAssetImage.new = function(assetName, opts) {
    ...
    if (!(assetName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 806, 15, "assetName != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 807, 15, "scale != null");
  ...
  (image_provider.NetworkImageLoadException.new = function(opts) {
    ...
    this[uri$] = uri;
    if (!(uri != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 885, 16, "uri != null");
    if (!(statusCode != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 886, 16, "statusCode != null");
  ...
  text_span.TextSpan = class TextSpan extends inline_span.InlineSpan {
    ...
    debugAssertIsValid() {
      if (!dart.test(dart.fn(() => {
        if (this.children != null) {
          for (let child of this.children) {
            if (!(child != null)) dart.assertFailed("TextSpan contains a null child.\n..." + "A TextSpan object with a non-null child list should not have any nulls in its child list.\n" + "The full text in question was:\n" + dart.str(this.toStringDeep({prefixLineOne: "  "})), "org-dartlang-app:///packages/flutter/src/painting/text_span.dart", 365, 18, "child != null");
            if (!dart.test(child.debugAssertIsValid())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_span.dart", 371, 18, "child.debugAssertIsValid()");
          }
        }
        return true;
